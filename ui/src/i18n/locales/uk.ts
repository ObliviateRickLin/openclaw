...
export const uk: TranslationMap = {
  ...
  codexSessions: {
    ...
    actions: {
      ...
      readTranscriptLabel: "Прочитати транскрипт для {title}",
    ...
    sidebar: {
      title: "Сеанси Codex",
      unavailable: "Сеанси Codex недоступні",
      viewAll: "Переглянути всі сеанси Codex",
      truncated: "Більше сеансів доступно в повному каталозі.",
    },
    transcript: {
      eyebrow: "Транскрипт Codex",
      back: "Усі сеанси Codex",
      you: "Ви",
      reasoning: "Міркування",
      command: "Команда",
      fileChange: "Зміна файлу",
      item: "Елемент Codex",
