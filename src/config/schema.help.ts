...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.utilityModel":
    "Optional lower-cost model (provider/model or alias) for short internal tasks such as generated titles, progress narration, and interactive approval-intent classification. Unset derives the primary provider's declared small model when available (otherwise the primary model); set to an empty string to disable utility routing.",
